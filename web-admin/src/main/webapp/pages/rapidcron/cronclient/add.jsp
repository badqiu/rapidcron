...
<rapid:override name="head">
	<title>创建CronClient</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">创建CronClient</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/rapidcron/cronclient/create.do" modelAttribute="cronClient" >
