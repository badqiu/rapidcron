...
<rapid:override name="head">
	<title>创建CronTaskLog</title>
</rapid:override>

<rapid:override name="content">
	<h2 id="title" class="text-center">创建CronTaskLog</h2>
	
	<form:form id="inputForm" method="post" cssClass="form-horizontal" action="${ctx}/crontasklog/create.do" modelAttribute="cronTaskLog" >
